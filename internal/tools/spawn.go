...
// SetSpawner swaps the subagent spawner backing this tool. Used by the
// application layer to wire a spawner after the tool registry is populated.
func (t *SpawnTool) SetSpawner(manager SubagentSpawner) {
	t.manager = manager
}
